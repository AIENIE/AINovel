...
- 默认 gRPC 地址为 `static://payservice.seekerhut.com:10021`，仍允许 `PAY_GRPC_ADDR` 环境变量覆盖。
...
- pay-service 只提供公共积分余额、公共积分兑换和失败回滚来源。AINovel 的小说项目积分账户、流水、签到展示、AI 扣费和兑换订单仍保存在本地项目账本中。
