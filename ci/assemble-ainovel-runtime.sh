...
install_exact "$repo_root/docker/staging-load-env-file.sh" \
  "$output_dir/docker/staging-load-env-file.sh" 0555
install_exact "$repo_root/ci/ainovel-runtime-compose.yml" \
  "$output_dir/docker-compose.yml" 0444
install_exact "$repo_root/ci/staging-oci-role-contract.json" \
