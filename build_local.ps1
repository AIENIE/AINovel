...
Set-DefaultEnv -Name "MYSQL_HOST" -Value "192.168.5.208"
...
Set-DefaultEnv -Name "REDIS_HOST" -Value "192.168.5.208"
...
Set-DefaultEnv -Name "QDRANT_HOST" -Value "http://192.168.5.208"
...
Set-DefaultEnv -Name "CONSUL_HOST" -Value "192.168.5.208"
...
Set-DefaultEnv -Name "PAY_GRPC_ADDR" -Value "static://payservice.seekerhut.com:10021"
