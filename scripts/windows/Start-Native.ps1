...
try {
    ...
    Wait-NativeLoopbackPort -Port 11041 -TimeoutSeconds 180 -ExpectedRootProcessId $backendProcess.Id -Name 'backend' -StateDirectory $stateDirectory -ProjectRoot $projectRoot
