-- AINovel Flyway baseline (MySQL)
-- Derived from the running `ainovel` schema on 2026-01-13 and adopted as V1 on 2026-07-06.
...
CREATE TABLE `slop_quality_runs` (
  ...
  `candidate_text_hash` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accepted_text_hash` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_text_hash` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `analysis_mode` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `risk_label` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `evidence_level` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `safe_claim` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `module_scores_json` longtext COLLATE utf8mb4_unicode_ci,
  `alternative_explanations_json` longtext COLLATE utf8mb4_unicode_ci,
  `revision_priorities_json` longtext COLLATE utf8mb4_unicode_ci,
  `rewrite_tasks_json` longtext COLLATE utf8mb4_unicode_ci,
  `summary` varchar(800) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_slop_run_story` (`story_id`),
  KEY `idx_slop_run_manuscript` (`manuscript_id`),
  KEY `idx_slop_run_scene` (`scene_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE `slop_quality_issues` (
  `id` binary(16) NOT NULL,
  `run_id` binary(16) NOT NULL,
  `dimension` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `severity` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `risk_score` int NOT NULL,
  `evidence` varchar(600) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `quote` varchar(800) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `module` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pattern_id` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issue_type` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `evidence_level` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alternative_explanations_json` longtext COLLATE utf8mb4_unicode_ci,
  `repair_hint` varchar(800) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_slop_issue_run` (`run_id`),
  KEY `idx_slop_issue_dimension` (`dimension`),
